#!/usr/bin/env python3
# ============================================================================
# GROUP-A alpha sweep on Kaggle — SAML only (parallel-safe, resumable)
#
...
#   cost   : ~3.2 h per seed -> 5 seeds is ~16 h = TWO sessions
#   sessions needed: 2 (the budget guard stops after ~3 seeds; rerun to finish)
#
