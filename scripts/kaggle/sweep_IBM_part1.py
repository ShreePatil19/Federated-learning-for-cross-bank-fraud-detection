#!/usr/bin/env python3
# ============================================================================
# GROUP-A alpha sweep on Kaggle — IBM, seeds [42, 0] (parallel-safe, resumable)
#
...
#   cost   : seeds [42,0] x ~4.0 h = ~8 h -> ONE session, guaranteed.
...
ONLY_DATASET     = 'IBM'
SEEDS            = [42, 0]           # this script's seed chunk (canonical full list:
