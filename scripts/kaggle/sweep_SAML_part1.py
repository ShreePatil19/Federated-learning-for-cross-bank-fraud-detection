#!/usr/bin/env python3
# ============================================================================
# GROUP-A alpha sweep on Kaggle — SAML, seeds [42, 0, 1] (parallel-safe, resumable)
#
...
#   cost   : seeds [42,0,1] x ~3.2 h = ~9.6 h -> ONE session, guaranteed.
...
ONLY_DATASET     = 'SAML'
SEEDS            = [42, 0, 1]        # this script's seed chunk (canonical full list:
